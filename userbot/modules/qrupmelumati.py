...
async def get_chatinfo(event):
    ...
    try:
        ...
        try:
            ...
            await event.reply("`Bu gizli qrup və ya buradan qadağan edilmişəm.`")
            return None
...
CmdHelp('qrupmelumati').add_command('qrupmelumati', None, 'Qrup haqqında məlumat verir.').add()
