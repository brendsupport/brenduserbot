...
async def okgoogle(img):
    """ .reverse əmri Google da şəkil axtarışı edər """
...
async def ParseSauce(googleurl):
    """ İstədiyiniz məlumat üçün HTML kodunu ayrın / cızın. """
...
CmdHelp('reverse').add_command(
    'reverse', '<cavab>', 'Fotoya və ya stikerə cavab verərək Google-da şəkli axtara bilərsiniz.'
).add()
