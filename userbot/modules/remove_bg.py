...
async def kbg(remob):
    """ .rbg əmri ilə görüntünün arxa planını silin """
    ...
    if "image" in contentType:
        with io.BytesIO(output_file_name.content) as remove_bg_image:
            remove_bg_image.name = "brend.png"
...
CmdHelp('rgb').add_command(
    'rbg', '<şəklin linki/cavab>', 'remove.bg API istifadə edərək görüntülərin arxa planını silər.'
).add()
