...
CmdHelp('lydia').add_command(
    'addcf', '<istifadəçi adı/cavab verməklə>', 'Lydia\'nın Avtomatik söhbətə imkan verir.'
).add_command(
    'remcf', '<istifadəçi adı/cavab verməklə>', 'Lydia\'nın avtomatik sohbeti deaktiv edin.'
).add_command(
    'repcf', '<kullanıcı adı/yanıtlayarak>', 'Lydia\'nın Müəyyən bir şəxs üçün avtomatik söhbətə imkan verir.'
).add()
