...
CmdHelp('spotify').add_command(
    'spotify aç', None, 'Spotify bio-nu aktivləşdirir.'
).add_command(
    'spotify kapa', None, 'Spotify bio aradan qaldırır.'
).add_command(
    'spotify np', '<animasyon süre = 5>', "Oyunçu mahnınızı Spotify-da cizgi şəklində göstərir. (Qısaldılmış əmr: .snp)"
).add_command(
    'spotify mp3', None, "Mahnınızı Spotify-da da deezer botda oynayır və ascii sənətini göndərir. (Kısaltma komut: .smp3)"
).add()
